...
const LandingPage = () => {
  ...
  const heroBgStyle = {
    backgroundImage: `
      linear-gradient(oklch(0.2 0.03 20 / 0.7), oklch(0.2 0.03 20 / 0.7)),
      url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='100%25' height='100%25'%3e%3cdefs%3e%3cpattern id='p' width='50' height='50' patternUnits='userSpaceOnUse'%3e%3crect width='100%25' height='100%25' fill='oklch(0.2 0.03 20)'/%3e%3cpath d='M10 10 Q15 0 20 10 T30 10' stroke='oklch(0.25 0.04 20)' stroke-width='1' fill='none'/%3e%3cpath d='M40 40 Q45 30 50 40 T60 40' stroke='oklch(0.25 0.04 20)' stroke-width='1' fill='none' transform='translate(-10,-10)'/%3e%3ccircle cx='35' cy='15' r='2' fill='oklch(0.22 0.03 20)'/%3e%3c/pattern%3e%3c/defs%3e%3crect width='100%25' height='100%25' fill='url(%23p)'/%3e%3c/svg%3e")
    `,
  ...
  const darkSectionBgStyle = {
    backgroundImage: `
      linear-gradient(oklch(0.2 0.03 20 / 0.9), oklch(0.2 0.03 20 / 0.9)),
      url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='100%25' height='100%25'%3e%3cdefs%3e%3cfilter id='n' x='0' y='0'%3e%3cfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='4' stitchTiles='stitch'/%3e%3c/filter%3e%3c/defs%3e%3crect width='100%25' height='100%25' fill='oklch(0.2 0.03 20)'/%3e%3crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.1'/%3e%3c/svg%3e")
    `,
    backgroundSize: 'cover',
    backgroundPosition: 'center',
  };
